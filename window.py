...
using ONLY aggressive regex fallback (no LLM classification), disabled input while streaming,
and in‑memory conversation history for context cohesion.
"""
...
# ---------------------------------------------------------------------------
# Aggressive regex fallback ONLY
# ---------------------------------------------------------------------------
...
class KolinaWindow(Gtk.Window):
    def __init__(self):
        ...
        # track streaming state and history
    ...
    def _stream_with_repo(self, repo_info: list[str]):
        system = (
            "Du er Kolina, en dansk Linux‑hjælper. SVAR KUN med officiel Ubuntu‑repo‑data. "
        ...
        # record assistant in history, finish
